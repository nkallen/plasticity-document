...
2. [Solid](#solid)
    ...
    3. [Face](#face)
    4. [Edge](#edge)
3. [Image and Mesh](#image-and-mesh)
    1. [Image](#image)
    2. [Mesh](#mesh)
...
### 1. Curve [#curve]
    ...
    - To select, switch to [**Edge Selection Mode**](/plasticity-essentials/plasticity-interface/selection-mode).
...
- To select, switch to [**Control Point Selection Mode**](/plasticity-essentials/plasticity-interface/selection-mode).
...
- To select, switch to [**Face Selection Mode**](/plasticity-essentials/plasticity-interface/selection-mode).
- Displayed in dark blue and turning light blue when selected, regions stop appearing after about 700 curves per plane because rendering becomes computationally expensive.
...
- To select, switch to [**Body Selection Mode**](/plasticity-essentials/plasticity-interface/selection-mode).
