...
Lofting Curves allow you to specify **Add Limit Point** and **Simplify** option.
...
3. Set the options in the Command Dialog and the Keyboard Shortcuts.
    - <Kst>Command Dialog</Kst>
        - **Simplify:** Specify whether to generate trimmed planar sections or maintain uniform geometry. (Default: **ON**)
    - <Kst>Keyboard Shortcuts</Kst>
        - <kbd>L</kbd> **Add Limit Point:** Specify the range to loft.
            - Make sure that [**Object Snaps**](/plasticity-essentials/plasticity-interface/snap) are enabled.
...
**Note:** Profiles and guides must be selected in the order in which surfaces flow.
</Callout>
...
You can loft Regions to create a Solid.
...
2. Guide Curves not touching the profiles.  Check that each connection has a blue-green dot, indicating intersection.  To ensure a precise touch, see [**Object Snaps**](/plasticity-essentials/plasticity-interface/snap).
